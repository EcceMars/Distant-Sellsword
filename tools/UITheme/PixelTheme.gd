## Pixel-perfect UI theme generator for 16x16 pixel art games
## Call PixelTheme.create() to get a configured theme
...
static func create()->Theme:
	...
	panel_style.bg_color = Color(0.1, 0.1, 0.12, 0.85)  # Dark semi-transparent
	panel_style.border_color = Color(0.3, 0.3, 0.35, 0.9)
